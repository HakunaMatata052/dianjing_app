  ...
  <div class="container">
    ...
    <div class="main">
      <div class="chunk">
        ...
        <div>仲喵_MG</div>
        <div>ID:19901220</div>
        <div>首单返12元上车找主播加群</div>
        <div>挑战TA</div>
      </div>
      <div class="chunk2">
        <van-cell class="hook" title="对战游戏类型" value="王者荣耀" />
        <van-cell
          is-link
          title="对战局数"
          @click="showPopup"
        ...
        <van-field
          class="pkManito__van-field"
          v-model="gameId"
          label="游戏ID(昵称)"
          placeholder="请输入游戏ID(昵称)"
        />
        <van-field
          class="pkManito__van-field"
          v-model.number="pkNumber"
      ...
      <div class="chunk3">
        <div class="remark">
          备注：
          <br />为了挑战赛顺利进行及结果判定，备注信息请填写完整。
          <br />备注包括：游戏终端、服务器、输赢判定规则等...
        </div>
        <div>确认挑战即同意《XXX用户协议》</div>
      </div>
